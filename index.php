...
<main class="container">
  ...
  <h1 class="text-center">Welcome to Sudan Cryptocurrncy Community! <br><small>SCC v 0.1</small></h1>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <form method="post" action="php/register.php">
        ...
        <div class="form-group">
          <input class="form-control" type="text" name="location" placeholder="Country">
        </div>
          <div class="form-group">

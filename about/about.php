...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.html">Sudan Cryptocurrncy team! 
</a></h1>
				<nav id="nav">
					<ul>
 						<li><a href="../home.php" class="button special">Back to home></a></li>
					</ul>
				</nav>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Welcome to Sudan Cryptocurrncy Community! 
</h2>
					...
					<div class="row 150%">
						<div class="4u 12u$(medium)">
							<section class="box">
								...
								<h3>Transactions are faster and private</h3>
					...
					<section class="profiles">
						<div class="row">
							<section class="3u 6u(medium) 12u$(xsmall) profile">
								...
								<h4>Ahmed abu alhassen</h4>
								<p>Software Engineer</p>
							</section>
							<section class="3u 6u$(medium) 12u$(xsmall) profile">
								<img src="images/usss-pic.png" alt="" />
								<h4>Ibrahim Rayis</h4>
								<p>Software Engineer</p>
							</section>
							<section class="3u 6u(medium) 12u$(xsmall) profile">
								<img src="images/uss-pic.png" alt="" />
								<h4>AlaDean EmadDean</h4>
								<p>Software Engineer</p>
							</section>

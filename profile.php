        ...
        <div class="panel-body">
          ...
          <form method="post" action="php/edit-profile.php">
            <div class="form-group">
              <input class="form-control" type="text" name="status" placeholder="wallet" value="">
            </div>

            <div class="form-group">
              <input class="form-control" type="text" name="location" placeholder="job" value="">
            </div>
    ...
    <div class="col-md-6">
      ...
      <div class="media">
        ...
        <div class="media-body">
          ...
          <p>Wallet: <?php echo $status; ?>, Job: <?php echo $location; ?></p>
        </div>
      </div>
      <!-- user profile -->
